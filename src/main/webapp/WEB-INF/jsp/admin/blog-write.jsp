                        ...
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle profile" data-toggle="dropdown"
                               aria-expanded="true"><img
                                    src="${pageContext.request.contextPath}/uploads/avatar.jpg" alt="user-img"
                                    class="img-circle"> </a>
            ...
            <div id="sidebar-menu">
                <ul>
                    ...
                    <li #if(active=='publish') class="active" #end>
                        <a href="/iblog/admin/blog/write.do" class="waves-effect #if(active=='publish') active #end"><i
                                class="fa fa-pencil-square-o" aria-hidden="true"></i><span> 写博客 </span></a>
                    </li>
                    <li #if(active=='article') class="active" #end>
                        <a href="/iblog/admin/blog/manage.do" class="waves-effect #if(active=='article') active #end"><i
                                class="fa fa-list" aria-hidden="true"></i><span> 博客管理 </span></a>
                    </li>
                    ...
                    <li #if(active=='links') class="active" #end>
                        <a href="/iblog/admin/friendly-link/manage.do"
                           class="waves-effect #if(active=='links') active #end"><i class="fa fa-link"
                                                                                    aria-hidden="true"></i><span> 友链管理 </span></a>
                    </li>

                    <li class="has_sub">
                        <a href="javascript:void(0)" class="waves-effect #if(has_sub=='other') active subdrop #end"><i
                                class="fa fa-cubes"></i><span> 其他管理 </span><span class="pull-right"><i
                                class="fa fa-plus"></i></span></a>
                        <ul class="list-unstyled">
                            <li #if(active=="visitor") class="active" #end>
                                <a href="/iblog/admin/visitor/manage.do"
                                   class="waves-effect #if(active=='visitor') active #end"><i class="fa fa-user"
                                                                                              aria-hidden="true"></i><span> 访客管理 </span></a>
                            </li>
                            <li #if(active=='comments') class="active" #end>
                                <a href="/iblog/admin/comment/manage.do"
                                   class="waves-effect #if(active=='comments') active #end"><i class="fa fa-comments"
                                                                                               aria-hidden="true"></i><span> 评论管理 </span></a>
                            </li>
                            <li #if(active=='category') class="active" #end>
                                <a href="/iblog/admin/category/manage.do"
                                   class="waves-effect #if(active=='category') active #end"><i class="fa fa-tags"
        ...
        <div class="content">
            <div class="container">
                ...
                <div class="form-group col-md-6" style="padding: 0 10px 0 0;">
                    <input name="title" id="title" type="text" required="true" class="form-control" value="无标题文章"
                           placeholder="请填写文章标签"/>
                </div>
                ...
                <div class="text-right" id="blog-editor">
                    <button type="button" id="save-btn" class="btn btn-primary waves-effect waves-light"
                            onclick="saveOrUpdateBlog()">
                        保存文章
                    </button>
                    <button type="button" id="publish-btn" class="btn btn-primary waves-effect waves-light"
                            onclick="updateStatus(1)">
                        发布文章
                    </button>
                    <button type="button" class="btn btn-warning waves-effect waves-light" onclick="updateStatus(0)">
                        存为草稿
                    </button>
                </div>
            </div>
...
<script src="${pageContext.request.contextPath}/lib/js/select2.min.js"></script>
