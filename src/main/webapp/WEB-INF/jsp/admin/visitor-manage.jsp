...
<div class="col-sm-3" >
    <div class="input-group">
        <input type="text" id="searchKey" class="form-control" placeholder="搜索访客">
...
<!-- 用户删除模态框 -->
<div id="delete-visitor-modal" class="modal fade" tabindex="-1" role="dialog">
...
<script type="application/javascript" src="${pageContext.request.contextPath}/js/visitor-manage.js"></script>
</body>
</html>
